...
class PageStore(object):
    ...
    def list(self, params={}, sortkey='id', sortdir='desc', page_number=1):
        ...
        data = self.container.call_api(settings.SEQUENCE_VIEWER_API_URL + '/restore/list', GET=params)
        return data['data']
    def create(self, data):
        return self.container.call_api(settings.SEQUENCE_VIEWER_API_URL + '/restore/create', POST=data)
