...
SEQUENCE_VIEWER_API_URL = 'http://%s:%s' % (os.environ['BACKUP_TOOLS_API_PORT_80_TCP_ADDR'], os.environ['BACKUP_TOOLS_API_PORT_80_TCP_PORT'])
...
#Single sign on
#---> remove here
#APPLICATION_URL     = 'http://sequence-viewer-admin.genopedia.local'
